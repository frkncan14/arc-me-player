    ...
    public void handleMessage(Message msg) {
      ...
      switch (msg.what) {
        ...
        case PROGRESS_CHANGED: {
          MtkLog.e(TAG, "progressFlag:" + progressFlag + "playstatus: " + mLogicManager.getVideoPlayStatus());
          if (progressFlag
...
//      hideMeteDataDelay();
  ...
  protected void onStop() {
    ...
    if(!"com.google.android.apps.tv.dreamx".equals(GetCurrentTask.getInstance(getApplicationContext()).getCurRunningPackageName()))
    {
