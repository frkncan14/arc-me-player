...
//	int[] rawArray;
	...
	/**
	 */
	private List<Coordinate> mCoordinate = new ArrayList<Coordinate>();
...
//	};
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		mXTileCount = (int)mContext.getResources().getDimension(R.dimen.score_view_tile_count_x);
		mYTileCount = (int)mContext.getResources().getDimension(R.dimen.score_view_tile_count_y);
		MtkLog.d(TAG, "onSizeChanged, w=="+w+", h="+h);
		MtkLog.d(TAG, "mXTileCount=="+mXTileCount+", mYTileCount="+mYTileCount);
