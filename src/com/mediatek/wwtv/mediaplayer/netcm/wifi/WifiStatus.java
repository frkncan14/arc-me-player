...
public final class WifiStatus {
	...
	private WifiStatus(Context context, String text){
        ...
        Log.d("WifiDongleControl","text=="+text);
	}
	 ...
	 *
	 */
	public static synchronized WifiStatus getInstance(Context context) {
	...
	public boolean isWifiConnected() {
		...
		return (state == SupplicantState.COMPLETED || state == SupplicantState.ASSOCIATED ||
