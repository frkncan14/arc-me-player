...
public class PlaybackService extends Service {
  ...
  public int getMusicAudioTrackNumber() {
    return mPlayback.getMusicAudioTrackNumber();
  }

  public int getMusicAudioTrackIndex() {
    return mPlayback.getMusicAudioTrackIndex();
  }

  public String getCurrentMusicAudioTrackType(int index) {
    return mPlayback.getCurrentMusicAudioTrackType(index);
  }
...
//  }
  ...
  public void registerAudioDurationUpdateListener(Object durationListener) {
		Log.i("PlaybackService","registerAudioDurationUpdateListener");
  }
