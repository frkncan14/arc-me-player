...
public class CiPinDialogFragment extends Fragment {
	private static final String TAG = "CiPinDialogFragment";
	...
	public CiPinDialogFragment() {
		super();
	    MtkLog.d(TAG, "CiPinDialogFragment");
	}
	...
	public static final class PinNumberPicker extends FrameLayout {
		...
		private CiPinDialogFragment mDialog;
		...
		void setPinDialogFragment(CiPinDialogFragment dlg) {
			mDialog = dlg;
		}
