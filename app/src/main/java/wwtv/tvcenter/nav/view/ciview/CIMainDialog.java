  ...
  public void showChildView(CIViewType viewType) {
    ...
    switch (viewType) {
      ...
      case CI_DATA_TYPE_ENQ:
        ...
        //NEED HANDLE
        PwdPincodeFragment mCiEnqInput = (PwdPincodeFragment) (((MediaPlayActivity) mContext).getFragmentManager()
...
/*
  ...
  public void showCiMenuInfo(String cardName, String cardTitle, String cardSubtitle,
    ...
    MtkLog.v(TAG, "showCiMenuInfo, cardTitle=" + cardName + ",cardName=" + cardTitle
    ...
    String[] mCIGroup = tempItemList.toArray(new String[0]);
