...
public class ConstPhoto {
	...
	public static final String TempFolderPath = FileSystemPath.LINUX_TMP_PATH+"/mtk";
	...
	public static final int MAX_2K_WIDTH = 1920;
	public static final int MAX_2K_HEIGHT = 1080;
	public static final int MAX_4K_WIDTH = 3840;
	public static final int MAX_4K_HEIGHT = 2160;
	public static final int MAX_8K_WIDTH = 7680;
	public static final int MAX_8K_HEIGHT = 4320;
	public static final int MAX_HD_WIDTH = 1366;
	public static final int MAX_HD_HEIGHT = 768;
