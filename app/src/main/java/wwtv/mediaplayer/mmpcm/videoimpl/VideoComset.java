...
public class VideoComset{
	...
	public int videoZoom(int videoZoomType) {
        ...
        if (Util.isUseExoPlayer()) {
			MtkLog.d(TAG,"isUseExoPlayer,not support zoom");
			return -1;
		}
	...
	private Rect getScreenOutputVideoRect(){
        ...
        MtkLog.d(TAG,"getScreenOutputVideoRect,r=="+r);
		return r;
	}
	...
	private Rect getScreenOutputRect(){
        ...
        MtkLog.d(TAG,"getScreenOutputRect,r=="+r);
		return r;
	}
	...
	private int setScreenOutputRect(Rect rect){
        MtkLog.d(TAG,"setScreenOutputRect",new Throwable());
