...
public interface IPlayList {
    ...
    boolean addFiles(int filterType,int fileType, List<String> files);
     ...
     *            file teype
     */
    List<String> getList(int filterType);
    ...
    void setShuffleMode(int filterType, boolean mode);

    boolean getShuffleMode(int filterType);
    ...
    String getCurrentPath(int filterType);
    File getCurrentFile(int filterType);
    boolean setCurrentFile(int filterType, String path);
    String getCurrentFileName(int filterType);
}
