...
public final class CommonIntegration {
    ...
    public static synchronized CommonIntegration getInstanceWithContext(Context context) {
    ...
    public static synchronized CommonIntegration getInstance() {
        if (null == instanceNavIntegration) {
            instanceNavIntegration = new CommonIntegration();
     ...
     * @return
     */
    public static synchronized MtkTvBroadcast getInstanceMtkTvBroadcast() {
        if (null == chBroadCast) {
            chBroadCast = MtkTvBroadcast.getInstance();
        }
    ...
    public static synchronized MtkTvUtil getInstanceMtkTvUtil() {
    ...
    public static synchronized MtkTvHighLevel getInstanceMtkTvHighLevel() {
...
//        }
    ...
    public int getSvlFromACFG() {
        return MtkTvConfig.getInstance().getConfigValue(MenuConfigManager.SVL_ID);
    }
    ...
    public int getChUpDownFilter() {
        ...
        switch (MarketRegionInfo.getCurrentMarketRegion()) {
            ...
            case MarketRegionInfo.REGION_SA:
                filter = MtkTvChCommonBase.SB_VNET_ACTIVE | MtkTvChCommonBase.SB_VNET_VISIBLE;// MtkTvChCommonBase.SB_VNET_ACTIVE                                                                           // MtkTvChCommonBase.SB_VNET_FAKE;
                break;
            default:
                break;
        }
    ...
    public int getChUpDownFilterEPG() {
        ...
        switch (MarketRegionInfo.getCurrentMarketRegion()) {
            ...
            case MarketRegionInfo.REGION_SA:
                ...
                break;
            case MarketRegionInfo.REGION_US:
                filter = MtkTvChCommonBase.SB_VNET_EPG | MtkTvChCommonBase.SB_VNET_VISIBLE;// MtkTvChCommonBase.SB_VNET_ACTIVE                                                                                              // |                                                                                           // MtkTvChCommonBase.SB_VNET_FAKE;
                break;
            default:
                break;
        }
    ...
    public boolean setOpacity(int opacity) {
        return MtkTvUtil.setOpacity(opacity);
    }
    ...
    */
    ...
    public boolean isCurrentSourceHasSignal(){
        return (chBroadCast.isSignalLoss());
    }
