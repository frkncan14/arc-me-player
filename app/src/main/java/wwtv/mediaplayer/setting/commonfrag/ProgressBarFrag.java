...
public class ProgressBarFrag extends Fragment{
    ...
    public static final String TAG = "ProgressBarFrag";
    ...
    public void onCreate(Bundle savedInstanceState) {
        MtkLog.d("ProgressBarFrag", "onCreate");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
    	...
    	ViewGroup mRootView = (ViewGroup)inflater.inflate(R.layout.progress_frag, null);
	...
	private void setProgressAndValue(int postion ,boolean fromUser){
        MtkLog.d("ProgressView", "setProgressAndValue postion:" + postion);
//		mProgressView.setProgress(mPostion);
//		if(!fromUser){
			showValue(mAction.mInitValue);
//		}else{
