...
public class BaseActionFragment extends BaseScrollAdapterFragment
    ...
    public static Bundle buildArgs(List<Action> actions, String name, int index) {
        ...
        args.putParcelableArrayList(EXTRA_ACTIONS, new ArrayList<Action>(actions));
    ...
    public void onSaveInstanceState(Bundle outState) {
        if (hasCreatedView()) {
            ...
            outState.putParcelableArrayList(EXTRA_ACTIONS, new ArrayList<Action>(mAdapter.getActions()));
