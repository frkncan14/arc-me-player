...
import com.mediatek.dlna.DmcEventListener;
import com.mediatek.dlna.FoundDMCEvent;
import com.mediatek.dlna.DigitalMediaRenderer;
import com.mediatek.dlna.DmrDevice;
import com.mediatek.dlna.Dmc;
import com.mediatek.DLNAStreamLoadable;
...
public class DmrHelper {
  ...
  public static void openDmr(Context context) {
    ...
    if (isNetworkConnect(context)) {
      ...
      Log.d(TAG, "openDmr resultOfStart:" + resultOfStart);
    } else {
...
//        + "  :" + mDmrObject.getMediaType());
  ...
  private static int getType(Context context) {
    ...
    Log.i(TAG, "ctype:" + ctype + " ,context=="+context);
    switch (ctype) {
      case Video:
